<div class="col-md-3">
  ...
  <div class="list-group">
      ...
      <div class="list-group">
        ...
        <a href="<?php echo Router::url(array('controller' => 'exames', 'action' => 'geral_exame')); ?>" class="list-group-item">Total Exames Solic.</a>
        ...
        <a class="active list-group-item">Edit/Del - Exames</a>
      </div>
  </div>
</div>
        ...
        <table class="table table-hover">
          ...
          <tbody>
              <?php foreach ($exames as $e): ?>
                <tr>
                  <td>
                    <center><a href=" <?php echo Router::url(array('controller' => 'exames', 'action' => 'edit', $e['Exame']['id'])); ?>" >Editar</a></center>
                  </td>
                  <td>
